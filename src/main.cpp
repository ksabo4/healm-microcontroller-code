...
BLEService bleService("55550000-0000-1000-8000-00805f9b34fb");

// Define a custom characteristic
BLECharacteristic bleCharacteristic("12340001-0000-1000-8000-00805f9b34fb", BLERead | BLEWrite); // Replace with your custom UUID
...
void loop()
{
  ...
  while (BLEisConnected)
  {
    ...
    bleCharacteristic.write( buf, strlen(buf) );
